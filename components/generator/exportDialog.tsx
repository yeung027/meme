...
export default function ExportDialog()
{
    ...
    return  <div className={componentClass}>
                <div className="w-full h-[60px] bg-my-purple3 dark:bg-my-dark shadow-[0_1px_8px_1px_rgba(0,0,0,0.7)] dark:shadow-[0_1px_8px_1px_#0d0d0d] grid grid-cols-2">
                    <div className="h-full flex justify-start items-center pl-4">
                        <span className="font-semibold font-roboto text-white dark:text-my-orange">
                            Export
                        </span>
                    </div>
                    <div className="h-full flex flex-row-reverse justify-start items-center pr-4">
                        <BiX
                            className="text-white text-2xl cursor-pointer dark:text-my-orange hover:opacity-50"
