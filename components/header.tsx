...
export default function Header(props:{title:string})
{
    ...
    useEffect(() => {
        if(isMobile)
        {
            ...
            setSubContainer2Class(defaultSubcontainer2Class+' landscape:w-[70px] landscape:pr-0 landscape:items-center landscape:justify-end landscape:flex-col landscape:pt-2 landscape:top-0');
        }
    });
