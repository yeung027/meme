...
export default function Header(props:{title:string})
{
    ...
    useEffect(() => {
        if(isMobile)
        {
            ...
            setSubContainer1Class(defaultSubcontainer1Class+' border border-4 border-blue-500 landscape:leading-[70px] landscape:self-center landscape:rotate-180 landscapeText landscape:w-[70px] landscape:pl-0 landscape:pl-6 landscape:items-center landscape:justify-end');
