...
export default function Header(props:{title:string})
{
    ...
    useEffect(() => {
        if(isMobile)
        {
            setContainerClass(defaultContainerClass+' landscape:h-screen landscape:flex landscape:flex landscape:flex-col-reverse');
            setSubContainer1Class(defaultSubcontainer1Class+' landscape:w-[70px] landscape:pl-0 landscape:-rotate-90 landscape:pl-6');
            setSubContainer2Class(defaultSubcontainer2Class+' landscape:w-[70px] landscape:pr-0 landscape:items-center landscape:flex-col landscape:pt-2');
        }
    });
