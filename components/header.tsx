...
export default function Header(props:{title:string})
{
    ...
    useLayoutEffect(() => {
        if(isMobile)
        {
            ...
            setSubContainer1Class(defaultSubcontainer1Class+' landscape:leading-[70px] landscape:rotate-180 landscapeText landscape:w-[70px] landscape:pl-0 landscape:justify-end');
