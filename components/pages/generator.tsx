...
const Home: NextPage<Props> = (props) => {
  ...
  const defaultContainerClass = 'bg-my-purple dark:bg-dark-purple w-screen h-screen grid grid-rows-[70px_1fr] desktop:flex desktop:flex-col overflow-hidden font-roboto'+darkModeTransformClass;
