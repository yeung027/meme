...
const Home: NextPage<Props> = (props) => {
  ...
  containerClass = 'h-screen bg-yellow-200 border border-4 border-red-500 bg-my-purple flex flex-col-reverse items-center pb-1 text-cyan-500 font-medium text-4xl'
  return (
