...
const Index: NextPage = () => {
  ...
  let subcontainer1Class = 'overflow-hidden grid grid-rows-[1fr] desktop:flex desktop:flex-row-reverse desktop:gap-6 h-screen desktop:min-h-fit desktopDark:bg-my-dark';
  ...
  let subSubcontainer1Class = 'desktop:ml-[316px] overflow-hidden min-h-full h-fit bg-lightGray dark:bg-my-dark w-full flex items-center justify-center gap-y-4 rounded-t-3xl desktop:rounded-none py-6 myLandscape:py-0 shadow-[0_-6px_7px_2px_rgba(105,0,197,1)] dark:shadow-[0_-10px_7px_2px_rgba(23,23,23,0.5)] desktop:shadow-none z-10';
