...
const Index: NextPage = () => {
  ...
  let subSubcontainer1Class = 'overflow-hidden min-h-full h-fit bg-lightGray dark:bg-my-dark w-full flex items-center justify-center gap-y-4 rounded-t-3xl desktop:rounded-none p-6 shadow-[0_-6px_7px_2px_rgba(105,0,197,1)] dark:shadow-[0_-10px_7px_2px_rgba(23,23,23,0.5)] desktop:shadow-none z-10';
