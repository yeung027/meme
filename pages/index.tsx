  ...
  return (
    <div className='bg-my-purple desktop:bg-white dark:bg-dark-purple w-screen h-screen grid grid-rows-[70px_1fr] desktop:flex desktop:flex-col overflow-hidden font-roboto'>
      ...
      <div className='grid grid-rows-[1fr_96px] desktop:flex desktop:flex-row-reverse desktop:gap-6 desktop:h-full desktop:bg-lightGray'>
        <div className='hidden desktop:block absolute bg-my-dark w-6 h-full left-0 -z-10 dark:z-0 left-[238px]' />
        ...
        <div className='border-t desktop:border-0 border-my-gray2 dark:border-my-dark h-24 w-full bg-white dark:bg-my-darkGray desktop:h-full desktop:w-[300px] desktop:shadow-[1px_0_15px_1px_rgba(0,0,0,0.2)]'>
          <ControlPanel />
        </div>
      </div>
    </div>
